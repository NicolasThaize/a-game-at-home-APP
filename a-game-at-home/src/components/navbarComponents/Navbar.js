...
class Navbar extends React.Component {
    state = {
        ...
        logo: process.env.PUBLIC_URL + "/compressed_img/logo.png",
        svgFb: process.env.PUBLIC_URL + "/compressed_img/svgFb.svg",
        svgTwt: process.env.PUBLIC_URL + "/compressed_img/svgTwt.svg",
        loggedIn: false
    }
    ...
    render() {
        ...
        return (
            <nav className="navbar container is-fluid is-fixed-top has-text-centered-touch navShadow" role="navigation"
                 aria-label="main navigation">
                <div className="navbar-brand">
                    <Link to="/" className="navbar-logo">
                        <img src={logo} height="65px" width="120px" alt="logo"/>
                    </Link>
                    <div
                        role="button"
