...
class Register extends React.Component {
    state = {
        ...
        firstName: "",
        lastName: "",
        svgWarning: process.env.PUBLIC_URL + "/compressed_img/svgWarning.svg",
    }
        ...
        return (
            <form onSubmit={this.handleSubmit} className="registerContainer mt-6 mb-6">
                ...
                <Input onChange={this.getInputData}
                       inputValues={{label: 'Prenom', placeholder: 'Grégoire', type: "text"}}/>
                <Input onChange={this.getInputData}
                       inputValues={{label: "Nom d'utilisateur", placeholder: 'Grégoire12', type: "text"}}/>
                <Input onChange={this.getInputData}
                       inputValues={{label: 'Adresse Email', placeholder: 'exemple@gmail.com', type: "email"}}/>
