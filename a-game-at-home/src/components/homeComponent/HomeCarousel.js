...
class HomeCarousel extends React.Component {
  state = {
    items: [
      {id: 1, title: 'item #1', image: process.env.PUBLIC_URL + "/img/carousel1.jpg"},
      {id: 2, title: 'item #2', image: process.env.PUBLIC_URL + "/img/carousel2.jpg"},
      {id: 3, title: 'item #3', image: process.env.PUBLIC_URL + "/img/carousel3.jpg"}
    ]
  }
